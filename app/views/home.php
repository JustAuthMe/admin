    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">E-mails sent</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= number_format(Persist::count('CoreEmailQueue', "WHERE sent_at IS NOT NULL AND error IS NULL")) ?></div>
                    </div>
                    <div class="col-auto text-primary">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Developers teams</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= number_format(Persist::count('ConsoleTeam')) ?></div>
                    </div>
                    <div class="col-auto text-success">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= 0 //number_format(Persist::count('ConsoleTeam')) ?></div>
                    </div>
